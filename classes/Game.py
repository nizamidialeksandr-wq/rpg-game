...
class Game:
    ...
    ENEMIES = [
        Enemy("Крыса-переросток", 60, 5, 12, 3, 15, 50,100),
        Enemy("Гоблин-неудачник", 80, 8, 18, 5, 20, 70,100),
        Enemy("Болотный слизень", 120, 10, 20, 5, 10, 100,100),
        Enemy("Лесной волк", 140, 15, 28, 12, 8, 130,100),
        Enemy("Орк-разведчик", 180, 18, 32, 15, 10, 180,100),
        Enemy("Теневой лучник", 150, 22, 40, 20, 25, 200,100),
        Enemy("Вампир-отступник", 200, 25, 45, 25, 10, 250,100),
        Enemy("Паладин падший", 280, 20, 38, 10, 5, 280,100),
        Enemy("Древний лич", 350, 30, 55, 15, 15, 350,100),
        Enemy("Дракон-разрушитель", 500, 35, 60, 20, 5, 500,100)
    ]    
